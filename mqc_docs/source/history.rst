...
and the development of complex quanutm chemistry software. Most of the development was spent
writing the pic libraries, Metalquicha was mostly a side projecto to showcase the capabilities
applied to quanutm chemistry.

However, after the presentation at Pacifichem, I had some personal leave and time to polish the code
and add more features. I think it might be a useful program for the community, so I decided
to make things nice and add some documentation for maybe some users to try it out.

This is a purely hobby project, so as long as I am not on leave (most of the time) I only work
on this on my off time and weekends, so please be patient with bug fixes and new features.
